...
<?php
$id = $_GET['id'];
$sql = "SELECT * from product_color where color_id = $id";
        ...
        <div class="row">
            <div class="col-md-8">
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Edit Color</label>
                        <input type="text" class="form-control" name="colorname" value="<?php echo $color ?>">
                    </div>
...
if (isset($_POST['update'])) {
    ...
    $sql = "update `product_color` set `color_name` = '$color' where color_id = $id";
    $result = mysqli_query($con, $sql);
